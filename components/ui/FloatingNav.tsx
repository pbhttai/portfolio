  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="group border text-sm font-medium relative border-neutral-200 dark:border-white/20 text-black dark:text-white px-4 py-2 rounded-full cursor-pointer">
          <span className="flex flex-row justify-center items-center gap-1">
            <FiDownload />
            <p>Resume</p>
          </span>

          <span className="absolute inset-x-0 w-1/2 mx-auto -bottom-px h-px bg-linear-to-r from-transparent via-blue-500 to-transparent transition-colors duration-300 group-hover:via-yellow-500" />
        </button>
