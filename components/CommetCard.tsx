...
export function CometCardDemo() {
  return (
    <CometCard rotateDepth={0.5} translateDepth={1}>
      <button
        type="button"
        className="my-10 flex w-80 cursor-pointer flex-col items-stretch rounded-3xl border-0 bg-[#1F2121] p-2 saturate-0 md:my-20 md:p-4"
      ...
      >
        <div className="mx-2 flex-1">
          <div className="relative mt-2 aspect-3/4 w-full">
            <img
              loading="lazy"
              className="absolute inset-0 h-full w-full rounded-3xl bg-black object-cover contrast-75"
